...
export default function About() {
  return (
    <div className="bg-gray-50 min-h-screen pt-20 md:pt-24 pb-12 px-6">
      {/* Full-width hero with blue overlay */}
      <section className="w-screen mb-12 -mx-6 z-0">
        <div
          className="relative p-12 overflow-hidden min-h-80 z-0"
          style={{
        ...
        >
          {/* blue translucent overlay to improve contrast and make image appear transparent */}
          <div className="absolute inset-0 bg-blue-600/60 z-10" aria-hidden />

          <div className="relative z-20 flex items-center justify-center min-h-80">
            <div className="text-center text-white max-w-4xl mx-auto px-6">
              ...
              <div className="flex justify-center gap-4">
                <a
                  href="/form"
                  className="inline-block w-full sm:w-auto px-6 py-3 bg-yellow-400 text-black rounded-2xl font-semibold hover:bg-yellow-500 transition"
                >
                  Request a Mentor
                </a>
                <a
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {teachersData.map((t) => (
          ...
          >
            ...
            <button className="w-full py-3 bg-yellow-400 text-white font-bold rounded-2xl hover:bg-[#4a36d4] transition-colors shadow-lg shadow-indigo-100 active:scale-95 transform">
              Select as Mentor
            </button>
          </div>
        ))}
